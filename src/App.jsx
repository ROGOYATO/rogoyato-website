  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-slate-800 dark:text-slate-100">
      ...
      <button
        type="button"
        onClick={toggleTheme}
        className="fixed bottom-4 right-4 z-40 inline-flex items-center gap-2 rounded-full border border-slate-300/80 bg-white px-3 py-2 text-slate-700 shadow-sm transition hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:hover:bg-slate-800"
