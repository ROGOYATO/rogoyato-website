  ...
  return (
    ...
    >
      <header className="rounded-3xl border border-white/10 bg-slate-900/75 p-6 sm:p-8">
        ...
        <h1 className="mt-2 font-heading text-3xl text-white sm:text-4xl">Ekip Yapisi</h1>
        <p className="mt-3 max-w-3xl text-slate-300">
          Uretim sureci alt birimlerle yurutulur. Uyeler ilgi alanina gore birime yerlesir, ortak
          etkinliklerde capraz takim modeli uygulanir.
        </p>
      </header>
